                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-9 input-group">
                                                <span class="input-group-addon" id="basic-addon7"></span>
                                                <input type="text" name="adresse_bailleur" value="{{ old('') }}" class="form-control @error('adresse_bailleur') is-invalid @enderror" placeholder="Veuillez entrer l'adresse du bailleur">
