                                    ...
                                    <div class="col-sm-12">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-9 input-group">
                                                ...
                                                <input type="text" name="nom_plan_action" value="{{ old('nom_plan_action') }}" class="form-control" placeholder="Veuillez entrer le nom du plan d'action">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-9 input-group">
                                                <span class="input-group-addon" id="basic-addon7"></span>
                                                <textarea name="commentaire" id="" class="form-control" value="{{ old('commentaire') }}" rows="1" placeholder="Veuillez faire une observation sur le plan d'action"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
