        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header"  style="text-align: center;">
                    <h3>Nouveau responsable d'activité</h3>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-9 input-group">
                                                <span class="input-group-addon" id="basic-addon7"></span>
                                                <input type="text" name="prenom_responsable_activite" value="{{ old('prenom_responsable_activite') }}" class="form-control" placeholder="Veuillez entrer le prénom du responsable">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-sm-3">
