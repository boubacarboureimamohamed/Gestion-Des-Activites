                            ...
                            <div class="col-sm-6">
                                <div class="row">
                                    ...
                                    <div class="row form-group">
                                            ...
                                            <div class="col-sm-9 input-group">
                                                <span class="input-group-addon" id="basic-addon7"></span>
                                                <input type="text" name="prenom_responsable_activite" value="{{ $responsable_activite->prenom_responsable_activite }}" class="form-control" placeholder="Veuillez entrer le prénom du responsable">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-sm-3">
